            ...
            echo '<tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btn-sm btnEditarCliente" data-toggle="modal" data-target="#modalEditarCliente" idCliente="'.$value["id"].'" title="Editar"><i class="fa fa-pencil"></i></button>';
                        
                        

                      if($_SESSION["perfil"] == "Administrador"){
                  echo '<button class="btn btn-danger btn-sm btnEliminarCliente" idCliente="'.$value["id"].'">
                          <i class="fa fa-trash"></i>
                        </button>';
                }

                echo '<button class="btn btn-info btn-sm btnVerReceta" idCliente="'.$value["id"].'" title="Ver receta">
                        <i class="fa fa-eye"></i>
                      </button>
                      <button class="btn btn-secondary btn-sm btnHistorialVentas" idCliente="'.$value["id"].'" title="Historial de ventas">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoDocumentoId"  maxlength="10" required " placeholder="CI/NIT">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" min="0" class="form-control input-lg" name="editarDocumentoId" id="editarDocumentoId" maxlength="10" required " placeholder="CI/NIT">

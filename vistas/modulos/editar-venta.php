<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <i class="ion ion-arrow-right-a"></i> EDITAR ORDEN DE TRABAJO
      ...
      <div class="col-lg-5 col-xs-12">
        ...
        <div class="box box-success">
              ...
              <div class="box">
                ...
                foreach ($listaProducto as $key => $value) {
                  ...
                  echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-3">
                          ...
                          <input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value="0" stock="'.$stockAntiguo.'" nuevoStock="'.$value["stock"].'" required>
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg" min="0" id="nuevoDescuentoVenta" name="nuevoDescuentoVenta" value="" onfocus="s()" onkeyup="SumarDatosFinancieros()" placeholder="0" required>
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input-lg" id="nuevoTotalFinal" name="nuevoTotalFinal" value="<?php echo $venta["totalfinal"]; ?>" onfocus="s()" onkeyup="SumarDatosFinancieros()" total="" placeholder="000" readonly required>
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg" min="0" id="Abono" name="Abono" value="<?php echo $venta["abono"]; ?>" onkeyup="SumarDatosFinancieros()" placeholder="0" required>
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input-lg" id="SaldoPendiente" name="SaldoPendiente" value="<?php echo $venta["pendiente"]; ?>" onkeyup="SumarDatosFinancieros()" total="" placeholder="000" readonly required>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control  input-lg" id="Observaciones" name="Observaciones" value="<?php echo $venta["observaciones"]; ?>" required>
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right"><i class="ion ion-arrow-right-a"></i> GUARDAR CAMBIOS</button>

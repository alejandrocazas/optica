                ...
                <div class="form-group row nuevoProducto">
                  ...
                  <div class="col-xs-3" style="padding-left:0px">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" min="1" class="form-control" id="nuevoPrecioProducto" name="nuevoPrecioProducto" placeholder="000" readonly required>
                          ...
                          <td style="width: 50%">
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" min="1" class="form-control" id="nuevoTotalVenta" name="nuevoTotalVenta" placeholder="000" readonly required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="nuevoDocumentoId" placeholder="CI/NIT" required>

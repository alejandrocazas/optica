  ...
  window.addEventListener("load", function () {
    swal({
      ...
      if (result.value) { window.location = "ventas"; }
			...
			} elseif ($_POST["nuevoFormaPago"] == 'ABONO'){
				$datos = array(
			...
			} elseif ($_POST["nuevoFormaPago"] == 'RETIRO'){
				$datos = array(
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>ESTADO VENTA</td> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>ABONO</td>
					<td style='font-weight:bold; border:1px solid #eee;'>SALDO</td>
					<td style='font-weight:bold; border:1px solid #eee;'>RETIRO</td>		
			...
			foreach ($ventas as $row => $item){
			 ...
			 echo utf8_decode("<tr>
		 		...
		 		echo utf8_decode("</td>
					...
					<td style='border:1px solid #eee;'>$ ".number_format($item["totalfinal"],2)."</td>
					<td style='border:1px solid #eee;'>$ ".number_format($item["abono"],2)."</td>
					<td style='border:1px solid #eee;'>$ ".number_format($item["pendiente"],2)."</td>
					<td style='border:1px solid #eee;'>$ ".number_format($item["retiro"],2)."</td>
